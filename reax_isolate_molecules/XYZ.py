...
class XYZ:
	...
	def export(self, filename):
		#Remove all of the None entries by creating a new list. Remember: Deleting
		#elements from a list while looping doesn't seem to work all that well.
		#Another method would be to just count up the number of None's and then subtract
		#that from the total number of rows.
		new_rows = []
		for row in self.rows:
			try:
				new_rows.append(map(str, row))
			except TypeError: #Means that row isn't a list
				pass #Do nothing
